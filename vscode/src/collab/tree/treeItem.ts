...
import { SelfCommands, EXTENSION_ID } from '../common/constants';

const selfExtension = vscode.extensions.getExtension(EXTENSION_ID) as vscode.Extension<any>;
const BASE_PATH = path.join(selfExtension.extensionPath, 'vscode', 'resources', 'icons', 'presence');
  ...
  constructor(
    ...
    if (channel) {
      ...
      const chatArgs: ChatArgs = {
        ...
        user,
        providerName,
        source: ChatEventSource.activity
      };
      this.command = {
