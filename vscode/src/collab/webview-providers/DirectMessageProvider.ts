...
export class DirectMessageProvider implements vscode.WebviewViewProvider {

	public static readonly viewType = 'collab.direct_messages';
	...
	private _getHtmlForWebview(webview: vscode.Webview) {
		...
		const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(mediaPath, 'direct-message.js'));
		const styleMainUri = webview.asWebviewUri(vscode.Uri.joinPath(mediaPath, 'direct-message.css'));
				...
				<ul class="direct-message-list">
					<li class="">
						<a href="" tabindex="0" class="">
							...
							</span><span class="">Welcome Bot</span>
