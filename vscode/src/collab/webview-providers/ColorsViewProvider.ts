...
export class ColorsViewProvider implements vscode.WebviewViewProvider {
	...
	private _getHtmlForWebview(webview: vscode.Webview) {
		...
		const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(mediaPath, 'color-view.js'));
		const styleMainUri = webview.asWebviewUri(vscode.Uri.joinPath(mediaPath, 'color-view.css'));
